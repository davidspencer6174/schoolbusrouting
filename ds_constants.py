...
#allowable ds_route time by some slack to allow for still
#picking up other students.
SLACK = 1.1
 
#Load travel time matrix and multiply by TT_MULT
TRAVEL_TIMES = np.load('/Users/cuhauwhung/Google Drive (cuhauwhung@g.ucla.edu)/Masters/Research/school_bus_project/Willy_Data/mixed_load_data/travel_times.npy')*TT_MULT
...
#solution for a ds_route before giving up and using the greedy method
...
STUDENTS, SCHOOLS_STUDENTS_MAP, ALL_SCHOOLS = setup_ds_students([prefix+'phonebook_parta.csv',
