...
from utils import convert_to_common, convert_from_common
import copy
...
def is_equal(route_1, route_2):
    ...
    if route_1.schools_path==route_2.schools_path and pairs_1 == pairs_2:
        return True
    else:
        return False
