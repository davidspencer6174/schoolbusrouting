import constants
from ds_locations import ds_School, ds_Student
import matplotlib.pyplot as plt
import numpy as np
import pickle
from ds_utils import stud_trav_time_array

geocodes = open("/Users/cuhauwhung/Google Drive (cuhauwhung@g.ucla.edu)/Masters/Research/school_bus_project/Data/csvs/all_geocodes.csv", "r")
codes = []
